...
public:
    ...
    static std::unique_ptr<Command> CreateCommand(RuntimeType runtime_type, CommandType command_type);
    ...
    /// @return Command object
    static std::unique_ptr<Command> CreateCommand(RuntimeType runtime_type, CommandType command_type, const std::string& app_name);
};